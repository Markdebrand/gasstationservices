...
def send_email(subject: str, body_text: Union[str, dict], to: Optional[Iterable[str]] = None, reply_to: Optional[str] = None, from_email: Optional[str] = None, cc: Optional[Iterable[str]] = None) -> dict:
...
async def async_send_email(subject: str, body_text: Union[str, dict], to: Optional[Iterable[str]] = None, reply_to: Optional[str] = None, from_email: Optional[str] = None, cc: Optional[Iterable[str]] = None) -> dict:
    """
