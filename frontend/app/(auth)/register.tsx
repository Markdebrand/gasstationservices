...
const styles = StyleSheet.create({
  ...
  title: { marginTop: 8, textAlign: 'center', fontSize: 22, fontWeight: '600', color: '#0f172a' },
  ...
  input: { width: '100%', marginTop: 4, backgroundColor: '#fff', borderWidth: 1, borderColor: '#E2E8F0', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 12, ...Platform.select({ ios: { shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 4 }, android: { elevation: 0 } }) },
  ...
  smallText: { marginTop: 12, textAlign: 'center', fontSize: 12, color: '#64748B' },
});
