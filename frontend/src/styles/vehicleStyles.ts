...
export default StyleSheet.create({
  ...
  countBadge: { position: 'absolute', right: -6, top: -6, backgroundColor: '#b91c1c', height: 22, minWidth: 22, paddingHorizontal: 6, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  plate: { fontSize: 16, fontWeight: '700', color: '#0F172A' },
  meta: { fontSize: 12, color: '#64748B', marginTop: 2 },
  cta: { backgroundColor: '#b91c1c', borderRadius: 16, height: 44, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 16 },
