...
export default StyleSheet.create({
  ...
  arrivalBadge: { width: 120, height: 120, borderRadius: 120, backgroundColor: '#b91c1c', alignItems: 'center', justifyContent: 'center', shadowColor: '#000', shadowOpacity: 0.18, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 6 },
