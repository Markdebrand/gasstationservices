...
export default StyleSheet.create({
  ...
  fuelCardActive: { borderColor: '#b91c1c', backgroundColor: 'rgba(255,200,200,0.05)' },
  ...
  pillActive: { backgroundColor: '#b91c1c', borderColor: '#b91c1c' },
  ...
  link: { marginTop: 6, color: '#b91c1c', fontSize: 12, fontWeight: '600' },
  ...
  cta: { marginTop: 16, backgroundColor: '#b91c1c', borderRadius: 16, height: 48, alignItems: 'center', justifyContent: 'center' },
  ...
  muted: { color: '#64748B' },
  value: { color: '#0F172A' },
  applyButton: { height: 36, borderRadius: 10, paddingHorizontal: 8, minWidth: 60, backgroundColor: '#b91c1c', alignItems: 'center', justifyContent: 'center' },
